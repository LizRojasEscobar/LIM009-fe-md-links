...
var optionsforMdlinks = function optionsforMdlinks(element) {
  var withoutValidate = "".concat(element.href, " ").concat(element.text.substring(0, 50), " ").concat(element.file);
